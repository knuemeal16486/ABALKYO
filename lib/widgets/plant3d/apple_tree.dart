...
class _AppleBuilder {
  ...
  void _grow(
    ...
    // 분기 수 증가: depth0→3, depth1→항상3, depth≥2→65% 확률로 3
    final n = depth == 0
        ? 3
    ...
    if (sn.leaf > 0) {
      ...
      for (int i = 0; i < cnt; i++) {
        ...
        final outDir = dir
            ...
            .normalized;
        _addLeaf(
          pos + outDir * (lp(0, 6, rng.nextDouble())), // 살짝 퍼져나옴
          outDir,
